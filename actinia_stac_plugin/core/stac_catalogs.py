...
This code shows the functions for STAC catalogs endpoint
"""
...
def createStacCatalogList():
    connectKvdb()
    exist = kvdb_actinia_interface.exists("result-catalog")
    ...
    catalog = kvdb_actinia_interface.read("result-catalog")
